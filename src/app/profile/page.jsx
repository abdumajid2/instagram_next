  ...
  return (
    <div className="sm:max-w-[640px] ml-[100px] mt-5">
      ...
      <div className="p-5 bg-white">
        <Swiper slidesPerView={6} spaceBetween={10} freeMode modules={[FreeMode]} className="mySwiper">
          ...
          <SwiperSlide className="flex flex-col items-center justify-center">
            <button
              className="flex flex-col items-center justify-center w-16 h-16 rounded-full border-2 border-gray-300 text-gray-500 hover:border-gray-500 hover:text-gray-700"
      ...
      {storyOpen && freshStories[storyIndex] && (
        ...
        >
          ...
          <div className="absolute top-4 left-4 right-4">
            ...
            <div className="flex items-center gap-3 text-white/90">
              ...
              {viewedMap[freshStories[storyIndex].id] && (
                <span className="ml-3 text-xs px-2 py-0.5 rounded bg-white/15">Viewed</span>
              )}
            </div>
          </div>
          ...
          >
            <button
              className="rounded-full p-3 bg-white/10 hover:bg-white/20"
