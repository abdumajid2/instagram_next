		...
		<>
			<div className='flex justify-between items-center'>
				<div className='w-[100%] lg:w-[20%] fixed top-0  h-screen overflow-y-auto p-4 gap-4 flex flex-col bg-white shadow-md'>
					<p className='text-2xl font-semibold mb-2'>{t("SettingPage.1")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={showNotificationsModal}>{t("SettingPage.3")}</p>
					</div>

					<p className='text-gray-600 mb-4'>{t("SettingPage.4")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={() => showFriendModal()}>{t("SettingPage.6")}</p>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={() => showEnemyModal()}>{t("SettingPage.7")}</p>
					</div>

					<p className='text-gray-600 mb-4'>{t("SettingPage.8")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<Link href={'/chats'}>{t("SettingPage.9")}</Link>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={() => showComentModal()}>{t("SettingPage.10")}</p>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={() => showRepostModal()}>{t("SettingPage.11")}</p>
					</div>

					<p className='text-gray-600 mb-4'>{t("SettingPage.12")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={showLikeModal}>{t("SettingPage.13")}</p>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={showLanguageModal}>{t("SettingPage.14")}</p>
					</div>

					<p className='text-gray-600 mb-4'>{t("SettingPage.15")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<Link href={'/profile'}>{t("SettingPage.16")}</Link>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<Link href={'/login'}>{t("SettingPage.17")}</Link>
					</div>

					<p className='text-gray-600 mb-4'>{t("SettingPage.18")}</p>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<p onClick={() => alert(t("SettingPage.20"))}>{t("SettingPage.19")}</p>
					</div>
					...
					<div className='flex items-center gap-3 text-gray-800 hover:text-blue-600 cursor-pointer'>
						...
						<Link href={'/profile'}>{t("SettingPage.22")}</Link>
					</div>
				</div>
					...
					{confidentialityModal && (
						<div className='max-w-2xl mx-auto p-6'>
							...
							<div className='space-y-6'>
								...
								<div className='p-4 bg-gray-50 rounded-lg'>
									<h3 className='font-medium text-gray-800 mb-3'>{t("SettingPage.45")}</h3>

									<div className='space-y-4'>
										<div className='flex justify-between items-center'>
											<div>
												<p className='text-gray-700'>{t("SettingPage.46")}</p>
												<p className='text-sm text-gray-500'>
													{t("SettingPage.47")}
												</p>
											</div>
										...
										<div className='flex justify-between items-center'>
											<div>
												<p className='text-gray-700'>{t("SettingPage.48")}</p>
												<p className='text-sm text-gray-500'>
													{t("SettingPage.49")}
												</p>
											</div>
								...
								<div className='px-4 pb-4 pt-2 text-gray-600'>
									...
									<div className='mt-4 space-y-3'>
										<label className='flex items-center justify-between space-x-3'>
											<span>Русский</span>
											<button onClick={()=>TranslateClick('ru')}>Применить</button>
										</label>
										<label className='flex items-center justify-between space-x-3'>
											<span>English</span>
											<button onClick={()=>TranslateClick('en')}>Apply</button>
										</label>
										<label className='flex items-center justify-between space-x-3'>
											<span>Точики</span>
											<button onClick={()=>TranslateClick('tj')}>Муроҷиат кунед</button>
										</label>
									</div>
								</div>
							</details>
