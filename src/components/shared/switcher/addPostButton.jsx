...
import { action } from "@/assets/icon/layout/svg";
  ...
  return (
    <>
      <Modal
        ...
        footer={null}
        className="md:!fixed !top-1/2 !left-1/2 md:!w-[45vw] !-translate-x-1/2 !-translate-y-1/2"
      >
        ...
        <section className="flex flex-col items-center justify-center mb-[30vh]">
          <form
            onSubmit={addNewPost}
